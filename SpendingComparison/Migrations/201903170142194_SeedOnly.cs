    ...
    public partial class SeedOnly : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        IncomeMultiplierId = c.Int(nullable: false, identity: true),
                        IncomeRangeId = c.Int(nullable: false),
                        Groceries = c.Double(nullable: false),
                        RestaurantsAndDining = c.Double(nullable: false),
                        RentOrMortgage = c.Double(nullable: false),
                        Utilities = c.Double(nullable: false),
                        Telephone = c.Double(nullable: false),
                        Household = c.Double(nullable: false),
                        HouseholdEquipment = c.Double(nullable: false),
                        Clothing = c.Double(nullable: false),
                        Vehicles = c.Double(nullable: false),
                        Gasoline = c.Double(nullable: false),
                        HealthCare = c.Double(nullable: false),
                        Entertainment = c.Double(nullable: false),
                        Education = c.Double(nullable: false),
                    })
                .PrimaryKey(t => t.IncomeMultiplierId)
